...
class User(Base):
    ...
    is_add_channel: Mapped[bool | None] = mapped_column(Boolean, default=False)
    ...
    channel: Mapped["Channel"] = relationship(
        "Channel",
        back_populates="user",
        uselist=False,  # False — если связь один-к-одному, True — если юзер может иметь несколько каналов
...
class Channel(Base):
    ...
    user_id: Mapped[int] = mapped_column(
        ...
        unique=True  # если один юзер — один канал, убери если будет один ко многим
    )
